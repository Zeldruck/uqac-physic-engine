...
{
	return Vector3<T>(
		vec.x * m_values[0] + vec.y * m_values[4] + vec.z * m_values[8],
		vec.x * m_values[1] + vec.y * m_values[5] + vec.z * m_values[9],
		vec.x * m_values[2] + vec.y * m_values[6] + vec.z * m_values[10]
	);
}
